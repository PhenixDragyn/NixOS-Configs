{
  ...
  in 
  {
    ...
    nixosConfigurations = {
      ...
      nixos-lt = libx.mkNixOS { hostname = "nixos-lt"; username = "ejvend"; system = "x86_64-linux"; desktop = "hypr"; type = "default"; theme = "ia-dark"; unfree = true; };
    ...
    homeConfigurations = {
      ...
      "ejvend@nixos-lt" = libx.mkHome { hostname = "nixos-lt"; username = "ejvend"; system = "x86_64-linux"; desktop = "hypr"; type = "default"; theme = "ia-dark"; };
