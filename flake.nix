...
inputs = { # Stable Packages
  ...
  in 
  {
    ...
    nixosConfigurations = {
      ...
      nixos-lt = libx.mkNixOS { hostname = "nixos-lt"; username = "ejvend"; system = "x86_64-linux"; desktop = "hyprland"; type = "default"; theme = "onedark-dark"; unfree = true; };
    ...
    homeConfigurations = {
      ...
      "ejvend@nixos-lt" = libx.mkHome { hostname = "nixos-lt"; username = "ejvend"; system = "x86_64-linux"; desktop = "hyprland"; type = "default"; theme = "onedark-dark"; };
