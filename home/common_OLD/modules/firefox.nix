...

{
  home.file.".mozilla/firefox/default/chrome" = {
    source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/NixOS/home/common/modules/firefox";
  ...
  programs.firefox = {
    ...
    profiles.default = {
      ...
      settings = {
        ...
        # "network.http.max-urgent-start-excessive-connections-per-host" = 5; "network.http.pacing.requests.enabled" = false;
