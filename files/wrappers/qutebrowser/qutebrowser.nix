...
Bard
  ...
  home.file.".config/qutebrowser/qute-home.html".text = generateHomepage "Default" "Fira Code Nerd Font" config;
  home.file.".config/qutebrowser/logo.png".source = ./qutebrowser-logo.png;
  home.file.".browser/Teaching/config/qute-home.html".text = generateHomepage "Teaching" "Fira Code Nerd Font" config;
  home.file.".browser/Teaching/config/logo.png".source = ./qutebrowser-logo.png;
  home.file.".browser/Tech/config/qute-home.html".text = generateHomepage "Tech" "Fira Code Nerd Font" config;
  home.file.".browser/Tech/config/logo.png".source = ./qutebrowser-logo.png;
  home.file.".browser/Gaming/config/qute-home.html".text = generateHomepage "Gaming" "Fira Code Nerd Font" config;
  home.file.".browser/Gaming/config/logo.png".source = ./qutebrowser-logo.png;
  home.file.".browser/Gamedev/config/qute-home.html".text = generateHomepage "Gamedev" "Fira Code Nerd Font" config;
  home.file.".browser/Gamedev/config/logo.png".source = ./qutebrowser-logo.png;
  home.file.".browser/Bard/config/qute-home.html".text = generateHomepage "Bard" "Fira Code Nerd Font" config;
